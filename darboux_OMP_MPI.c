...
/*****************************************************************************/
// Fonction qui gère les échanges de frontières (to make it cleaner :D )
...
// Fonction pour rassembler les données de tous les processus vers le processus 0
